// This file serves as the backing script for the Add Reminder web page. It facilitates the adding/removing of fields for different reminder types and the
// submission of the form to the server.

// It first finds various elements on the page to add functionality and use in functions.
...
// It then sets the same event listener on the datePicker element.
