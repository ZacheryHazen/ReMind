1. To run the Re-Mind web application on localhost:3000, one should first download the files necessary for running the project (the directory main) and unzip them.
...
17. Click Connect and then click File, then click Open, and then click File... and select the 'DatabaseCreationScript.sql' file in the main directory.

18. Click 'Execute' in SSMS and you should see 'Commands completed successfully' in the Messages window. 

19. Click File, Open, and then File... once again and select the 'SchemaCreationScript.sql' file in the main directory.

20. To the left of 'Execute' in SSMS, change the database from 'master' to 'reMind'. Then click 'Execute'.

21. Click File, Open, and then File... one more time and select the 'TableCreationScripts.sql' file in the main directory. Click 'Execute' in SSMS once more.
